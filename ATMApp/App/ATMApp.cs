...
namespace ATMApp
{
    public class ATMApp : IUserLogin, IUserAccountActions, ITransaction
    {
        ...
        public void InitializeData()
        {
            ...
            {
                new UserAccount{Id=1, FullName = "Jeff Bezos", AccountNumber=978417,CardNumber =8829981639096658, CardPin=986081,AccountBalance=50000000.00m,IsLocked=false},
                new UserAccount{Id=2, FullName = "John Doe", AccountNumber=809908,CardNumber =3872823715812613, CardPin=715616,AccountBalance=4000.00m,IsLocked=false},
                new UserAccount{Id=3, FullName = "Jane Doe", AccountNumber=032702,CardNumber =2970678253691593, CardPin=051278,AccountBalance=2000.00m,IsLocked=true},
            };
